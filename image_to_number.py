...
IMAGES_DIR = r"/home/menashe/image_proses/PUBG_Images/image.png"   # התיקייה עם כל הסקרינשוטים מהמשחק
...
def test_run(templates):
    crop = get_ping_region(IMAGES_DIR)
    if crop is None:
        raise Exception
...
digits, number = test_run(templates)
